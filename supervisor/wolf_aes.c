...
void aes_core_asm(unsigned int r,word32 s[4],const word32*rk);
void aes_core_asm_opt(unsigned int r,word32 s[4],const word32*rk);

void aes_core(unsigned int r,word32 s[4],const word32*rk){
	/*word32 *s0=ps0;
	word32 *s1=ps0+1;
	word32 *s2=ps0+2;
	word32 *s3=ps0+3;*/
